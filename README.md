...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/frosty-pine-5b51#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-pine-5b51
```

A live public deployment of this template is available at [https://frosty-pine-5b51.templates.workers.dev](https://frosty-pine-5b51.templates.workers.dev)
